package com.example.diegorios.arcore;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static boolean checkIsSupportedDeviceOrFinish(final Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            Log.e(TAG, "Sceneform requires Android N or latter");
            Toast.makeText(activity, "Sceneform requires Android N or latter", Toast.LENGTH_LONG).show();
            activity.finish();
            return false;
        }
